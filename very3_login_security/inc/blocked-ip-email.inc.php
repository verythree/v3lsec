...
<head prefix="dcterms: http://purl.org/dc/terms">
  <title>Blocked IP Address (<?php echo $_state['ripa'];?> at <?php echo $v3_lsec['conf']['site'];?></title>
</head>
<html>
<body>
  IP Address <b><?php echo $_state['ripa'];?></b>  was blocked at <b><a href="https://<?php echo $v3_lsec['conf']['site'];?>/admin"><?php echo $v3_lsec['conf']['site'];?></a></b> on <b><?php echo date(DATE_RFC2822);?></b> for the next <?php echo round(($v3_lsec['conf']['security']['timeout'] - $_tleft)/60);?> minutes.
  <br/><br/>
