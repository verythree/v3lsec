...
<head prefix="dcterms: http://purl.org/dc/terms">
  <title>Admin Login at <?php echo $v3_lsec['conf']['site'];?></title>
</head>
<html>
<body>
  <b><?php echo $_state['auth'];?></b> logon for user <b><?php echo $_state['user'];?></b> to the admin interface at
  <b><a href="https://<?php echo $v3_lsec['conf']['site'];?>/admin"><?php echo $v3_lsec['conf']['site'];?></a></b> on <b><?php echo date(DATE_RFC2822);?></b>.<br/><br/>
